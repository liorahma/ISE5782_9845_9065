...
public class OurPictureMP1 {
    ...
    public void picture() {
        ...
        Color laneColor= new Color(255, 223, 128).scale(4d/3d);
...
//                .setMaterial(new Material().setKs(1).setKd(0.3).setKr(0.3).setShininess(19));
        ...
        _scene._geometries.add(bowlingPin1,lane,rightPolL,rightPolR,leftPolL,leftPolR,bowlingPin2,bowlingPin3,bowlingPin4,bowlingPin5,bowlingPin6);
